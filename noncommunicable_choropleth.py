...
def noncomm_choropleth():
	...
	country_death_rates_2012={'Country':[],'Noncommunicable diseases':[]}
	...
	map_layout = dict(
		title = 'Incidents of Death By Noncommunicable Diseases Per Country in 2012',
		geo =  geo_deets
		)

	blue_scale = [[0.0, 'yellow'], [1.0, 'green']]
	...
	stuff_plotly_needs = [ dict(
			...
			z = country_death_rates_2012['Noncommunicable diseases'],
	...
	ply.plot(plotly_fig, filename='Deaths-by-noncommunicable-diseases-map')
