...
def injuries_choropleth():
	...
	country_death_rates_2012={'Country':[],'Injuries':[]}
	...
	map_layout = dict(
		title = 'Incidents of Death By Injury Per Country in 2012',
		geo =  geo_deets
		)

	blue_scale = [[0.0, 'turquoise'], [1.0, 'darkblue']]
	...
	stuff_plotly_needs = [ dict(
			...
			z = country_death_rates_2012['Injuries'],
	...
	ply.plot(plotly_fig, filename='Deaths-by-injuries-map')
